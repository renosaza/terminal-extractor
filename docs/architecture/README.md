...
Это проект архитектуры; из схемы ниже реализована только CLI foundation host/gateway с `ping` через private Unix socket. Требования: [PRD](../product/prd.md). Решение по стеку: [TE-ADR-002](decisions/TE-ADR-002-stack.md).
